...
//
#ifndef USDPLATONIC_GENERATED_TETRAHEDRON_H
#define USDPLATONIC_GENERATED_TETRAHEDRON_H
...
/// \class UsdPlatonicTetrahedron
///
/// A platonic solid with 4 faces.  Each face is a equilateral triangle.
///
class UsdPlatonicTetrahedron : public UsdPlatonicRegularConvexPolyhedron
{
public:
    ...
    /// Construct a UsdPlatonicTetrahedron on UsdPrim \p prim .
    ...
    /// Destructor.
    USDPLATONIC_API
    virtual ~UsdPlatonicTetrahedron();
    ...
    ///
    /// \code
    /// UsdPlatonicTetrahedron(stage->GetPrimAtPath(path));
    /// \endcode
    ///
    USDPLATONIC_API
